...
**Assumptions:** - starting population is homozygot for the disease (aa) - healthy added individuals are homozygot without the disease (AA) - second generation can mate with sick individuum or hybrid
...
Functions we need: - Function that calculates probabillity for turning into different genotype - Function that split genotypes into alleles
...
<<<<<<< HEAD
simulate_one_gen <- function(N_aa, N_AA, N_Aa, w_aa, w_Aa_AA) {
...
>>>>>>> 31062caef5d35926b3a1949e1e4067c1b836703f
...
<<<<<<< HEAD
print(simulate_one_gen(N_aa, N_AA, N_Aa, w_aa, w_Aa_AA))
=======
